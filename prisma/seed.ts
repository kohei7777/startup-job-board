...
async function main() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      tags: 'ビジネス,FinTech',
      salaryMin: 800, salaryMax: 1500,
      location: '東京都千代田区', employees: '45名', founded: '2020年',
      requirements: '金融業界での実務経験3年以上,事業開発・アライアンス経験,ビジネスレベルの英語力',
      benefits: 'ストックオプション制度,副業OK,学習支援制度',
      industry: 'FinTech', jobType: 'ビジネス',
    },
    {
      title: 'プロダクトデザイナー',
      company: 'ヘルスケアAI株式会社',
    ...
    },
    {
      ...
      salaryMin: 800, salaryMax: 1300,
      location: '東京都新宿区', employees: '60名', founded: '2019年',
      requirements: 'PMまたはPdM経験2年以上,アジャイル開発の理解,データドリブンな意思決定経験',
      benefits: 'ストックオプション制度,リモートワーク可,副業OK,学習支援制度',
      industry: 'EdTech', jobType: 'PM',
    },
    {
      title: 'マーケティングマネージャー',
      company: 'コマースプラス株式会社',
    ...
    },
    {
      ...
      tags: 'エンジニア,SaaS,リモート可',
      salaryMin: 800, salaryMax: 1400,
      location: '東京都品川区', employees: '80名', founded: '2017年',
    ...
    },
    {
      ...
      location: '東京都中央区', employees: '150名', founded: '2016年',
      requirements: 'CFO・財務責任者経験,IPO準備経験,監査法人・投資銀行での経験',
      benefits: 'ストックオプション制度,役員待遇,社用車',
      industry: 'HealthTech', jobType: 'ビジネス',
    },
    {
      title: 'データサイエンティスト',
      ...
      tags: 'エンジニア,SaaS,リモート可',
      salaryMin: 700, salaryMax: 1200,
      location: '東京都渋谷区', employees: '35名', founded: '2020年',
